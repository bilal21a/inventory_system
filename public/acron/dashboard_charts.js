        ...
        if (document.getElementById('customLegendDoughnutChart')) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    var colors = ['#FFFFFF', '#2A6D00', 'orange', '#454545', '#00FF00', '#0000FF', '#800080', '#FF00FF', '#000080', '#008080', '#00FFFF', '#808000', '#800000', '#808080', '#C0C0C0'];
                    var i = 1;
                    ...
                    datasets: [
                        {
                            label: '',
                            data: feature_data,
                            backgroundColor: ['#7D65FC','#4E91ED','#71cc39','#D99E04','#F82305','#12DBD5','#9A59B5','#407BB3','#AAAAAA','#094479','#86753D','#FF5E45','#2DCB6F','#E67E22','#80735C','#8E60BE'],
                            borderColor: ['#3119B3','#1E55A1','#2A6D00','#6A4E06','#711104','#045B59','#5E147C','#0A3359','#4C4C4D','##0273D9','#554614','#9F2411','#055B29','#6B3505','#352A16','#471D73' ],
                        },
                    ],
                    labels: feature_name,
                    icons: ['messages', 'cupcake', 'loaf','chart-4','calendar','camera','pin','camera','file-music','clock','wifi','crosshair','file-music','file-video','file-video','camera'],
                },
            });
